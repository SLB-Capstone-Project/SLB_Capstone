  ...
  final response = await http.post(
    ...
    headers: {
      HttpHeaders.authorizationHeader:
          'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyTmFtZSI6IkFkbWluIiwiZXhwIjoxNzQzMTE1NTE2fQ.6hlGpXVCPyCZdaeueBm98fdFC5jbRgT6TOZJUg7XJ1Q',
      'Content-Type': 'application/json',
    },
    body: jsonEncode({'productsId': 0, 'category': 0, 'status': 'available'}),
  );
  /*if(response.statusCode != 200) {
    print(response.statusCode);
    throw Exception('Unable to connect');
